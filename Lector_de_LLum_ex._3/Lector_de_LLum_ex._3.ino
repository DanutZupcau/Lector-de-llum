...
void loop()
{
  ...
  {
    valLdr0 = map(valLdr0, 270, 900, 255, 0);   // mapejar valor de 0-1023 a 0-255
  }
  ...
  {
    valLdr1 = map(valLdr1, 270, 900, 255, 0);   // mapejar valor de 0-1023 a 0-255
  }
...
Serial.println(valLdr2);
  ...
  {
    valLdr2 = map(valLdr2, 270, 900, 255, 0);   // mapejar valor de 0-1023 a 0-255
  }
